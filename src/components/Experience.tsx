  ...
  const experiences = [
    {
      ...
      period: "May 2023 - Sept 2026",
      description: "Shipped 8 production applications across 12 client engagements in SaaS, e-commerce, and enterprise.",
      achievements: [
        "Architected and delivered 8 production apps across 12 client engagements using React, Next.js, and TypeScript",
        ...
        "Implemented Storybook across internal projects to standardize UI documentation and reduce design drift",
        "Created rules for AI-assisted development agents (Cursor, Copilot) to standardize team coding workflows",
